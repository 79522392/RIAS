...
<div class="main">
 <%
	...
	%>
        ...
        <p >我的密码：<td align="center"  height="55"><%=res.getString(3).replaceAll("(\\d{0})\\d{3}(\\d{0})","$1****$2")%><input  type="button" value="修改" class="button"onclick="window.location.href='UpdatePwd.jsp'"></td></p>
            </div>
          
<%
			}
			session.setAttribute("Old_password", res.getString(3));
